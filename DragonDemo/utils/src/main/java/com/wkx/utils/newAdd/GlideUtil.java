...
public class GlideUtil {
    ...
    public static void loadCornerImage(ImageView imageView, String filePath, RequestListener listener, float radius) {
        com.wkx.utils.glide_transformation.CornerTransform transform = new com.wkx.utils.glide_transformation.CornerTransform(UtilsApplication.getUtilsApplicaitonContext(), radius);
    ...
    public static void loadBlurredBackground(String imagePath, final ImageView imageView) {
        Glide.with(UtilsApplication.getUtilsApplicaitonContext()).load(imagePath)
                .apply(RequestOptions.bitmapTransform(new com.wkx
                        .utils.glide_transformation.BlurTransformation(20, 3)))
                        ...
                        imageView.post(new Runnable() {
                            ...
                            public void run() {
                                Glide.with(UtilsApplication.getUtilsApplicaitonContext()).load(R.drawable.ic_pic_load)
                                        .apply(RequestOptions.bitmapTransform(new com.wkx.utils.glide_transformation.BlurTransformation(20, 3)))
                                        .into(imageView);
                            }
                        });
                        return false;

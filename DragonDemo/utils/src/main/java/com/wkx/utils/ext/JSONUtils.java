...
public class JSONUtils {
    ...
    public static Long getLong(JSONObject jsonObject, String key, Long defaultValue) {
        if (jsonObject == null || com.wkx.utils.ext.StringUtils.isEmpty(key)) {
            return defaultValue;
        }
    ...
    public static Long getLong(String jsonData, String key, Long defaultValue) {
        if (com.wkx.utils.ext.StringUtils.isEmpty(jsonData)) {
            return defaultValue;
        }
    ...
    public static Map<String, String> parseKeyAndValueToMap(JSONObject sourceObj) {
        ...
        for (Iterator iter = sourceObj.keys(); iter.hasNext();) {
            ...
            com.wkx.utils.ext.MapUtils.putMapNotEmptyKey(keyAndValueMap, key, getString(sourceObj, key, ""));

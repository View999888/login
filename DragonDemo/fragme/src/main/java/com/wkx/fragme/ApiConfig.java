...
public class ApiConfig {
    ...
    public static final int DATA_GROUP = 10;//资料小组
    public static final int DATA_ESSENCE = 11;// 最新精华
    public static final int CLICK_TO_FOCUS = 12; //关注
    public static final int CLICK_CANCEL_FOCUS = 13;//取消关注


    public static final int VIP_BANNER_LIVE = 14;
    public static final int VIP_LIST = 15;

...
public class SystemUtils {
     ...
     * 唯一机器码
     * 已经在base中增加权限方法
     * TelephonyManager:供了一系列用于访问与手机通讯相关的状态和信息的get方法。其中包括手机SIM的状态和信息、电信网络的状态及手机用户的信息。在应用程序中可以使用这些get方法获取相关数据。/
     * Context.TELEPHONY_SERVICE:需要注意的是有些通讯信息的获取对应用程序的权限有一定的限制，在开发的时候需要为其添加相应的权限。
     */

    @SuppressLint("MissingPermission")
    public static String getDeviceId(Context context) {
        //android.permission.READ_PHONE_STATE.
        //!!!必需在AndroidManifest.xml中声明，非常必要，否则部分手机无权限，无法获得IMEI  IMEI:移动设备身份码的缩写
        String deviceId = "";
